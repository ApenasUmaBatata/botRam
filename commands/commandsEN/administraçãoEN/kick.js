...
module.exports = {
  ...
  run: async (bot, message, args) => {
    ...
    await member
      ...
      .catch(error =>
        message.reply(`${message.author}, não foi possível completar esta punição devido ao erro: ${error}`)); // caso ocorra um erro no final, vamos filtrar e avisar qual foi
