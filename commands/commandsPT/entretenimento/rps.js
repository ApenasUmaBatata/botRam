...
module.exports = {
    ...
    run: async (bot, message, args) => {
        ...
        if (!args[0]) {
            return message.reply(`\`\`\`Modo correto: ${prefix}${modouso.rps}\`\`\``)
        }
        ...
        if (choices.includes((args[0]).toLowerCase())) {
            ...
            return message.channel.send('Por favor inclua apenas pedra, papel ou tesoura!') //se a mensagem conter algo a mais alem de pedra/papel/tesoura o bot ira mandar a mensagem
        }
    }
}