...
module.exports = {
  ...
  run: async (bot, message, args) => {
    ...
    const cor = args[0];
     if(message.member.roles.cache.some(r=>["verde", "azul", "vermelho", "rosa", "amarelo", "roxo", "preto", "branco"].includes(r.name)) ) {
       message.delete()
       return message.channel.send(`você já possui cargo colorido`)
} else {
